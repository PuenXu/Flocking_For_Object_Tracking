...
random_data = np.loadtxt('random_ex.csv', delimiter=',', skiprows=1)[:150]

static_data = np.loadtxt('static_ex.csv', delimiter=',', skiprows=1)
rows_to_remove = np.arange(4, 150, 3)
...
axs1[0].plot(time, main['vel_mismatch'], label='No Adversary')
axs1[0].plot(time, static['vel_mismatch'], label='5 Static Adversarial Nodes')
axs1[0].plot(time, random['vel_mismatch'], label='5 Random Input Nodes')
axs1[0].set_title('Velocity Mismatch')
axs1[0].set_xlabel('Time (s)')
axs1[0].set_ylabel('Mismatch')
axs1[0].grid(True)
axs1[0].legend()
...
axs1[1].plot(time, mse_main, label='No Adversary')
axs1[1].plot(time, mse_static, label='5 Static Adversarial Nodes')
axs1[1].plot(time, mse_random, label='5 Random Input Nodes')
axs1[1].set_title('Mean Squared Error')
